...
High_0 = posx(400,-110,100,90.02,179.97,89.99); High_1 = posx(450,-110,100, 90.02,179.97,89.99); High_2 = posx(500,-110,100, 90.02,179.97,89.99)
Mid_0  = posx(400,-56,100, 90.02,179.97,89.99); Mid_1  = posx(450,-56,100,90.02,179.97,89.99); Mid_2  = posx(500,-56,100, 90.02,179.97,89.99)
Low_0  = posx(400,-9.5,100, 90.02,179.97,89.99); Low_1  = posx(450,-9.5,100, 90.02,179.97,89.99); Low_2  = posx(500,-9.5,100, 90.02,179.97,89.99)
...
def probe_and_get_z_contact():
    ...
    set_desired_force([0,0,F_TARGET_N, 0,0,0], [0,0,1,0,0,0], time=1, mod=DR_FC_MOD_REL)

    traveled = 0.0
    while traveled < PROBE_MAX_DN:
        movel(posx(0,0,PROBE_STEP,0,0,0), vel=VEL_PROBE, acc=ACC_PROBE, ref=DR_TOOL, mod=DR_MV_MOD_REL)

        if check_force_condition(DR_AXIS_Z, min=F_CONTACT_N, max=DR_COND_NONE, ref=DR_TOOL):
